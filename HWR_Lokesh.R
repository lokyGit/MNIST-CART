...
image.data = read.csv("/Users/lokeshpalacharla/Library/Mobile Documents/com~apple~CloudDocs/NEU/Classes/Summer 2020/Predictive Analytics/Week 3/MNIST-data/mnist_train.csv", header = F)
